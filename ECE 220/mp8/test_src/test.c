...
int main(){
	...
	game_orig = _make_game(3,5);
	game * game_cpy1 = _make_game(3,5);
	game * game_cpy2 = _make_game(3,5);
	...
	cell temparray[15] = {2, 4, 4, 8, 4, -1, -1, 4, -1, 2, 4, 8, 2, 4, -1};
	for( i =0; i<15;i++){
	...
	if( move_s(game_cpy1) == _move_s(game_cpy2))
		printf("test 9: pass - move_s returns the correct value\n");
	else
		printf("test 9: fail - move_s returns the incorrect value\n");
