...
class BinaryTree
{
    public:
        ...
        T max_val(Node* subRoot) const;

        T min_val(Node* subRoot) const;

        void getPathsHelper(Node* subRoot, std::vector<std::vector<T>>& paths, std::vector<T>& vec) const;
